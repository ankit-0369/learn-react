...
/*
  <header class="bg-white dark:bg-gray-700">
      ...
      <div className="hero min-h-screen bg-gray-700">
        <div className="hero-content flex-col lg:flex-row-reverse">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRrgXqSLjNUZXy_2TlchqD6WjwSbjt41dWn9Q&usqp=CAU" className="max-w-lg rounded-lg shadow-2xl" />
          <div>
            <h1 className="text-5xl font-bold">Box Office News!</h1>
            <p className="py-6"> Lorem, ipsum dolor sit amet consectetur adipisicing elit. Temporibus esse,
              dolorem sint soluta nam itaque enim recusandae distinctio veritatis veniam porro ab nesciunt quos
              dolores cupiditate, voluptate tempora fuga! Eveniet fugiat obcaecati corporis. Voluptates rerum
              necessitatibus voluptas animi, quos facilis. </p>
  ...
  <div className="carousel-item">
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTPCbpJLV4lcx-Zqpggb-AolWbN0_-vlBG54g&usqp=CAU" alt="Drink" />
  </div> 
  <div className="carousel-item">
