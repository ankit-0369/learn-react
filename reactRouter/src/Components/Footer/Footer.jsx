            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div className='flex flex-col justify-center'>
                            <h2 className="mb-6 text-sm text-center font-semibold text-gray-900 uppercase">Resources</h2>

                            <ul className="text-gray-500 font-medium grid grid-cols-2 gap-x-14">
                                <li className="mb-4">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-500 font-medium">
                                <li className="mb-4">
                                    <a
                                        href="https://github.com/ankit-0369"
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center">
                        © 2023
                        <a href="https://portfolio-ideas.netlify.app/" className="hover:underline">
                            k-ankit
                        </a>
                        . All Rights Reserved.
                    </span>
                    <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                        ...
                        <Link to="#" className="text-gray-500">
                            <svg
                                ...
                                <circle cx="32" cy="32" r="23" fill="#fd3c4f"></circle><ellipse cx="32" cy="61" opacity=".3" rx="19" ry="3"></ellipse><circle cx="32" cy="32" r="18" fill="#ffa1ac"></circle><path fill="none" stroke="#fd3c4f" stroke-miterlimit="10" stroke-width="5" d="M23.5,12.5c0,0,15,13,17,38"></path><path fill="#fd3c4f" d="M20.869,49.516l-3.941-3.078C24.093,37.263,34.871,32,46.5,32c2.305,0,4.612,0.211,6.857,0.626 l-0.909,4.916C50.502,37.183,48.501,37,46.5,37C36.421,37,27.079,41.562,20.869,49.516z"></path><path fill="#fd3c4f" d="M17.5,33c-2.022,0-4.052-0.163-6.033-0.483l0.799-4.936C13.983,27.859,15.745,28,17.5,28 c10.307,0,19.777-4.729,25.983-12.975l3.995,3.007C40.318,27.544,29.392,33,17.5,33z"></path><path fill="#fff" d="M32,14c2.577,0,4.674-1.957,4.946-4.461C35.352,9.19,33.699,9,32,9	C19.297,9,9,19.297,9,32c0,1.699,0.19,3.352,0.539,4.946C12.044,36.674,14,34.577,14,32C14,22.075,22.075,14,32,14z" opacity=".3"></path><path d="M54.461,27.054C51.956,27.326,50,29.423,50,32c0,9.925-8.075,18-18,18	c-2.577,0-4.674,1.957-4.946,4.461C28.648,54.81,30.301,55,32,55c12.703,0,23-10.297,23-23C55,30.301,54.81,28.648,54.461,27.054z" opacity=".15"></path><path fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" stroke-width="3" d="M15.047,23.427c1.878-3.699,4.932-6.705,8.666-8.522"></path>
                            </svg>
                            <span className="sr-only">Dribbble accounts</span>
                        </Link>
                    </div>
                </div>
            </div>
